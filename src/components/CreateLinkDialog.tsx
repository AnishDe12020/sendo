...
import CreateCompressedNFTDialog from "./CreateCompressedNFTLink";
      ...
      <DialogContent className="overflow-y-auto h-[32rem]">
        ...
        <Tabs defaultValue="token" className="w-full">
          <TabsList className="w-full my-4">
            ...
            <TabsTrigger value="compressed-nft">Compressed NFTs</TabsTrigger>
          </TabsList>
          <TabsContent value="token">
            <CreateTokenLink setIsOpen={setIsOpen} />
          </TabsContent>
          <TabsContent value="compressed-nft">
            <CreateCompressedNFTDialog setIsOpen={setIsOpen} />
          </TabsContent>
        </Tabs>
      </DialogContent>
    </Dialog>
